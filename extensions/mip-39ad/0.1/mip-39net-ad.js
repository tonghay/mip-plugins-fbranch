...
var e;
// 定义了广告的通用模块
define('extensions/mip-39net-ad/0.1/mip-39net-ad', ['require', 'zepto', 'customElement'], function (require) {
    ...
    customElem.prototype.build = function () {
        ...
        var script = [
            ...
            'acAsId = ' + id + ';acFormat = 0;acMode = 1;acGroupId = 1;acServerBaseUrl = "d-test.39.net/";',
            '</script>'];
...
// 注册mip业务标签组件
require(['extensions/mip-39net-ad/0.1/mip-39net-ad'], function (t) {
    MIP.registerMipElement('mip-39net-ad', t);
});
